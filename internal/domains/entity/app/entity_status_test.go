...
func TestEntityStatusAction_AllSynced(t *testing.T) {
	dir := t.TempDir()
...
func TestEntityStatusAction_ModifiedFile(t *testing.T) {
	dir := t.TempDir()
...
func TestEntityStatusAction_NewFile(t *testing.T) {
	dir := t.TempDir()
...
func TestEntityStatusAction_OrphanedFile(t *testing.T) {
	dir := t.TempDir()
...
func TestEntityStatusAction_LegacyEmptyHash(t *testing.T) {
	dir := t.TempDir()
...
func TestEntityStatusAction_MixedStatuses(t *testing.T) {
	dir := t.TempDir()
